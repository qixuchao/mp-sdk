...
(function () {
  ...
  var GdtManager = /*#__PURE__*/function () {
    ...
    _createClass(GdtManager, [{
      ...
      key: "bindSlot",
      value: function bindSlot(consumerSlotId, container, complete) {
  ...
  var registerQQ = (function (Union) {
    ...
    Union.register('gdt', {
      ...
      onInit: function onInit(data, _ref) {
        ...
        GdtManager$1().bindSlot(data.consumerSlotId, this.id, function (status) {
          clearInterval(timeout);
    ...
    Union.register('ptgapi', {
      ...
      onInit: function onInit(data, _ref) {
        ...
        var params = {
          ...
          //移动端
          mimes: 'img,c',
          rsize: "".concat(this.slotSize.width, "*").concat(this.slotSize.height),
          // 广告位容器的尺寸
  ...
  var Slot = /*#__PURE__*/function () {
    ...
    function Slot(container) {
      ...
      this.slotContainerSize = {
        width: this.$container.clientWidth || this.$container.scrollWidth || this.$container.offsetWidth,
        height: this.$container.clientHeight || this.$container.scrollHeight || this.$container.offsetHeight
      }; //
