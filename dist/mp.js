!(function () {
  ...
  function T(t, n, e) {
    ...
    return o.replace(/__(.*?)__/g, function (t) {
      ...
      return void 0 === o
        ? ''
        : ((m((n = o)) || Array.isArray(n)) && (n = JSON.stringify(n)),
  ...
  var C = window.navigator.userAgent,
    S = (/(iPhone|iPod|Android|ios|mobile)/i.test(C), /Android|Linux/.test(C)),
    _ = /\(i[^;]+;( U;)? CPU.+Mac OS X/gi.test(C),
    D =
  ...
  var E,
    ...
    q = (function () {
      function t() {
        var e = this;
        c(this, t),
          a(this, 'proxyComplete', function (n) {
            return function (t) {
              var o,
                i = e.slotMap[n],
                r = [];
              try {
                r = window.GDT.getPosData(n).data;
              } catch (t) {}
              i &&
                1 === i.status &&
                i.fns &&
                (Array.isArray(t)
                  ? t.forEach(function (t, n) {
                      var e = i.fns.shift();
                      if (!e) return !1;
                      window.TencentGDT.NATIVE.renderAd(t, e.container),
                        e.complete(!0, r[n] && r[n]),
                        (o = i.next.shift());
                    })
                  : i.fns.shift().complete(!1)),
                (o = o || i.next.shift()) && o();
            };
          }),
          a(this, 'initSlot', function (t) {
            window.TencentGDT.push({
              placement_id: t.consumerSlotId,
              app_id: t.appid,
              type: 'native',
              count: 3,
              onComplete: e.proxyComplete(t.consumerSlotId)
            });
          }),
        ...
        e(t, [
          ...
          },
          {
            ...
            value: function (t, n, e) {
              ...
              i &&
                ((i.status = 1),
                i.fns.push({ container: n, complete: e }),
            ...
            value: function (e) {
              ...
              E ||
                ...
                (TencentGDT.TN.adClose = function (t, n) {
                  var e = o(t.traceid);
                  e && (e.onClose(), P.apply(this, arguments));
                }));
            }
          },
          {
    ...
    B = (function () {
      ...
      function r(t, n) {
        ...
        return (
          c(this, r),
          a(d((e = o.call(this))), 'onLoaded', function (t) {
            e.log('bidSuc', t),
              (e.adInfo = t),
              e.trigger('loaded'),
              e.trigger('complete');
          }),
          a(d(e), 'onTimeOut', function () {
            var t =
      ...
      return (
        ...
        e(r, [
          ...
          },
          {
            key: 'logError',
            value: function (t) {
              var n = { DATA: { err: t, errorMessage: G[t] } };
              this.log('error', n);
            }
          },
          {
    ...
    (N = B).register('gdt', {
      ...
      onInit: function (t, n) {
        var e = n.onLoaded,
          ...
          i = setTimeout(function () {
            o('10002'), clearInterval(i), (i = null);
          }, R);
        A().bindSlot(t.consumerSlotId, this.id, function (t, n) {
          clearInterval(i), t ? e(n) : (x('无广告'), o('10000'));
        });
      },
      ...
      onShow: function () {
        ...
        this.adInfo &&
          ...
          (n = { title: this.adInfo.txt, desc: this.adInfo.desc, imgList: t }),
          this.log('imp', { EXT: n }));
      },
      getWeight: function () {},
      reload: function (t) {
        A().loadAd(t.consumerSlotId);
      }
    }),
    B.register('bd', {
    ...
    B.register('ptgapi', {
      ...
      onInit: function (t, n) {
        var e = this,
          ...
          c = [
            T(this.data.trackingV2Data.clickTracking[0], {
  ...
  var H = function (t) {
    ...
    F = (function () {
      function s(t) {
        ...
        c(this, s),
          a(this, 'pickConsumer', function (t) {
    ...
    W = (function () {
      function n(t) {
        c(this, n), a(this, 'Ver', '1.8.0'), (this.slots = {}), this.init(t);
      }
      return (
        e(n, [
          {
          ...
          },
          {
            ...
            value: function (t, n, e, o) {
              this.slots[n.id] = new F(t, n, this.config, o);
            }
          }
        ]),
        n
