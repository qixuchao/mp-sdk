!(function () {
  ...
  function P(e, t) {
    ...
    var o = t.data || {};
    (o.v = Math.random().toString(36).slice(-6)), (o.jsonp = r), T(_(e, o));
  }
  function B(n, i) {
    var r = 0;
    return function (e) {
          ...
          },
          {
            ...
            value: function (e, t) {
              var n = 1 < arguments.length && void 0 !== t ? t : {},
                ...
                r = (this.data.trackingV2Data || this.data.trackingData)[ne[e]];
              W(r, i);
            }
          },
          {
  ...
  s(re, 'VENDORS', {}),
    s(re, 'unionInstances', {}),
    s(re, 'vendorLoaded', {}),
    s(re, 'register', function (e, t) {
      var n = 2 < arguments.length && void 0 !== arguments[2] && arguments[2];
      (d(re.VENDORS[e]) || n) &&
        ((re.VENDORS[e] = new re(e, t)), (re.vendorLoaded[e] = 'init'));
    }),
    (Q = re).register('gdt', {
        ...
        U().bindSlot(e.consumerSlotId, this, function (e, t) {
          var n =
            2 < arguments.length && void 0 !== arguments[2]
              ? arguments[2]
              : '10000';
          clearInterval(o), e ? i(t) : (q('无广告'), r(n));
        });
      },
      ...
      onShow: function () {
        function e() {
          ...
          o.adInfo &&
            ...
            (new Image().src = _(o.adInfo.apurl, {
    ...
    re.register('ptgapi', {
      ...
      onInit: function (e, t) {
        var n,
          ...
          r = t.onError,
          o = setTimeout(function () {
            r('10002'), clearTimeout(o), (o = null);
          }, 1e4),
          a = this.slotSize.height || 54;
        try {
          n = JSON.parse(e.style) || {};
          var s = this.slotSize.width || screen.width,
            a = s * (n.height / n.width);
        } catch (e) {}
        var c = {
            ip: 'client',
            mid: e.appId || 209,
            ...
            device_type: 1,
            mimes: 'img,c',
            rsize: ''.concat(this.slotSize.width, '*').concat(a),
          ...
          callback: function (e) {
            ...
            clearTimeout(o),
              Array.isArray(e.ad) && e.ad.length && e.ad[0].src
                ? ((t = b(e.ad[0].src, { M_PRECLICK: l })), i(t))
                : r('10000');
          }
        });
      },
        ...
        var o = this,
          ...
          n = setInterval(function () {
            ...
            r.length &&
              ...
              (e = function () {
                var t = [],
                  n = i.querySelector('a').getAttribute('href');
                y(i, 'click', function (e) {
                  o.onClick(),
                    window.postMessage(
                      JSON.stringify({
                        type: 'adClick',
              ...
              0 < this.consumerLength
                ? ((n = document.querySelector(this.container)),
                  ...
                  M(this.consumers, function (e) {
                    var t = re.use(e.consumer.consumerType);
                    t &&
          ...
          },
          {
            ...
            value: function (e) {
              ...
              M(e, function (i) {
                h(i)
                  ? i.call(t, {
                      union: { register: re.register, use: re.use },
                      utils: {}
                    })
                  : v(i) &&
                    (d(i.id)
