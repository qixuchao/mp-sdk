            ...
            if (Array.isArray(res)) {
              res.forEach(function (ad, index) {
                ...
                if (currentSlot) {
                  ...
                  currentSlot.complete(true, materialData[index] && materialData[index]);
                  fn = slot.next.shift();
                } else {
                  return false;
                }
  ...
  var registerQQ = (function (Union) {
    Union.register('gdt', {
      ...
      onInit: function onInit(data, _ref) {
        ...
        GdtManager$1().bindSlot(data.consumerSlotId, this.id, function (status, adInfo) {
          clearInterval(timeout);
  ...
  var Slot = /*#__PURE__*/function () {
    ...
    function Slot(container) {
      ...
      _defineProperty(this, "pickConsumer", function (union) {
        ...
        if (priorityPolicy === 0 || priorityPolicy === 3 && union.data.weight === _this.consumerMaxWeight) {
          _this.race(union);
