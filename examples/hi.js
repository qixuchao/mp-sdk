...
window.M$P_M_C = {
  ...
  "slotBiddings": [{
    ...
    "slotBidding": [{
      ...
      "trackingData": {
        "bidTracking": "http://t2.fancyapi.com/NTAwMDAwMDAyMge6de/NTAwMDAwMDAyMAbf9b/b?ad=__ADID__&dt=__DATA__&ex=__EXT__&l=__LBS__&m1a=__ANDROIDID__&m2=__IMEI__&m5=__IDFA__&m6a=__MAC__&mo=__OS__&nn=__APP__&ns=__IP__&oa=__OAID__&pr=__PRICE__&tr=__REQUESTID__&ts=__TS__&o=",
        "errorTracking": "http://t2.fancyapi.com/NTAwMDAwMDAyMge6de/NTAwMDAwMDAyMAbf9b/e?ad=__ADID__&dt=__DATA__&ex=__EXT__&l=__LBS__&m1a=__ANDROIDID__&m2=__IMEI__&m5=__IDFA__&m6a=__MAC__&mo=__OS__&nn=__APP__&ns=__IP__&oa=__OAID__&pr=__PRICE__&tr=__REQUESTID__&ts=__TS__&o=",
        "impTracking": "http://t2.fancyapi.com/NTAwMDAwMDAyMge6de/NTAwMDAwMDAyMAbf9b/i?ad=__ADID__&dt=__DATA__&ex=__EXT__&l=__LBS__&m1a=__ANDROIDID__&m2=__IMEI__&m5=__IDFA__&m6a=__MAC__&mo=__OS__&nn=__APP__&ns=__IP__&oa=__OAID__&pr=__PRICE__&tr=__REQUESTID__&ts=__TS__&o=",
        "clickTracking": "http://t2.fancyapi.com/NTAwMDAwMDAyMge6de/NTAwMDAwMDAyMAbf9b/c?ad=__ADID__&dt=__DATA__&ex=__EXT__&l=__LBS__&m1a=__ANDROIDID__&m2=__IMEI__&m5=__IDFA__&m6a=__MAC__&mo=__OS__&nn=__APP__&ns=__IP__&oa=__OAID__&pr=__PRICE__&tr=__REQUESTID__&ts=__TS__&o=",
        "bidSucTracking": "http://t2.fancyapi.com/NTAwMDAwMDAyMge6de/NTAwMDAwMDAyMAbf9b/s?ad=__ADID__&dt=__DATA__&ex=__EXT__&l=__LBS__&m1a=__ANDROIDID__&m2=__IMEI__&m5=__IDFA__&m6a=__MAC__&mo=__OS__&nn=__APP__&ns=__IP__&oa=__OAID__&pr=__PRICE__&tr=__REQUESTID__&ts=__TS__&o=",
        "bidSelectedTracking": "http://t2.fancyapi.com/NTAwMDAwMDAyMge6de/NTAwMDAwMDAyMAbf9b/bs?ad=__ADID__&dt=__DATA__&ex=__EXT__&l=__LBS__&m1a=__ANDROIDID__&m2=__IMEI__&m5=__IDFA__&m6a=__MAC__&mo=__OS__&nn=__APP__&ns=__IP__&oa=__OAID__&pr=__PRICE__&tr=__REQUESTID__&ts=__TS__&o="
      },
      "templateInfo": null
    }]
  }, {
  ...
  "config": {
    ...
    "errTrackingUrl": "http://t2.fancyapi.com/NTAwMDAwMDAwNQ5f00/NTAwOTA0NTIyNg0aad/e?ad=__ADID__&dt=__DATA__&ex=__EXT__&l=__LBS__&m1a=__ANDROIDID__&m2=__IMEI__&m5=__IDFA__&m6a=__MAC__&mo=__OS__&nn=__APP__&ns=__IP__&oa=__OAID__&pr=__PRICE__&tr=__REQUESTID__&ts=__TS__&o=",
    "ttAppId": "",
    "gdtAppId": "1110655203",
...
!(function () {
        ...
        Union.register('qq', {
          ...
          onMounted: function onMounted() {
            ...
            TencentGDT.TN.doClick = function (params) {
              var container = document.querySelector('.' + that.id);
  ...
  */
      ...
      value: function render(selector) {
        ...
        if (container) {
          ...
          if (this.sandbox) ; else {
            addEventListener(this.$container, function () {
              _this3.log('click');
            });
          }
        } else {
  ...
  var callFunction = function callFunction() {
    return arguments[0] && arguments[0].apply(this, aArray.prototype.slice.call(arguments, 1));
  }; // 广告位状态
  /**
   * 通过权重计算使用消耗方
        ...
        if (this.consumerLength > 0) {
          each(this.consumers, function (con) {
            ...
            if (union) {
              ...
              union.requestId = "".concat(_this.slotId, "-").concat(con.consumer.consumerSlotId); // 存放不同消耗方的不同配置信息
              ...
              union.on('init', function () {// console.log('init');
                ...
                _this.race(union);
              }).on('complete', _this.handleComplete).on('close', function () {
