...
!(function () {
  ...
  function y(t, n) {
    if (t)
      ...
      else if (m(t)) for (var o in t) if (n && !1 === n(t[o], o)) break;
  }
  function w(t, n) {
  ...
  function b(t, n, e) {
    var o = 0 < arguments.length && void 0 !== t ? t : '',
      ...
      c = { OS: 3, APP: window.location.hostname, IP: '', TS: +new Date() };
  ...
  function O(t, n) {
    ...
    var r = n.data || {};
    (r.v = Math.random().toString(36).slice(-6)), (r.jsonp = i), v(k(t, r));
  }
  var I =
          ...
          s(this, 'proxyComplete', function (e) {
            return function (t) {
              ...
              n &&
                1 === n.status &&
                (Array.isArray(t)
                  ? (window.TencentGDT.NATIVE.renderAd(t[0], n.container),
                    n.complete(!0))
                  : n.complete(!1));
            };
          }),
        ...
        e(t, [
          ...
          },
          {
            ...
            value: function (t, n, e) {
              var o = this.slotMap[t];
              o &&
                ((o.status = 1),
                (o.container = n),
                (o.complete = e),
                window.jsInited && this.loadAd(t));
            }
          },
          {
            key: 'loadAd',
          ...
          s(d(e), 'onTimeOut', function () {
            var t =
              0 < arguments.length && void 0 !== arguments[0]
                ...
                : '10002';
            '1' === e.status &&
              (e.logError(t), e.trigger('complete'), e.destroy());
          }),
      ...
      return (
        e(r, null, [
          {
            key: 'use',
            value: function (t) {
              if (!h(r.VENDORS[t]) && r.VENDORS[t] instanceof r) {
        ...
        e(r, [
          ...
          },
          {
            key: 'logError',
            value: function (t) {
              var n = { DATA: { err: t, errorMessage: N[t] } };
              this.log('error', n);
            }
          },
          {
            ...
            value: function (t, n) {
              var e = 1 < arguments.length && void 0 !== n ? n : {},
                o = {
                  ...
                  DATA: a(a({}, this.requestData), e.DATA),
                  EXT: e.EXT
                },
  ...
  s(R, 'VENDORS', {}),
    s(R, 'unionInstances', {}),
    s(R, 'vendorLoaded', {}),
    s(R, 'register', function (t, n) {
      var e = 2 < arguments.length && void 0 !== arguments[2] && arguments[2];
      (h(R.VENDORS[t]) || e) &&
        ((R.VENDORS[t] = new R(t, n)), (R.vendorLoaded[t] = 'init'));
    }),
    (_ = R).register('gdt', {
      ...
      onInit: function (t, n) {
        ...
        (S = S || new j()).bindSlot(t.consumerSlotId, this.id, function (t) {
          clearInterval(r), t ? o() : (M('无广告'), e.logError(1e4), i());
        });
      },
      ...
      onMounted: function () {
        var o;
        D ||
          ((D = TencentGDT.TN.doClick),
          (A = TencentGDT.TN.adClose),
          (o = function (t) {
            var n = document.querySelector('div[id*="' + t + '"]');
            return _.unionInstances[n.parentNode.id];
          }),
          (TencentGDT.TN.doClick = function (t, n) {
            var e = o(n);
            e && (e.onClick(), D.apply(this, arguments));
          }),
          (TencentGDT.TN.adClose = function (t, n) {
            var e = o(n);
            e && (e.onClose(), A.apply(this, arguments));
          }));
      },
      onShow: function () {
        var i = this,
      ...
      onInit: function (t, n) {
        ...
        (window.slotbydup = window.slotbydup || []).push({
          ...
          (e = setTimeout(function () {
            r(), clearInterval(c), (c = null);
          }, P));
        var c = setInterval(function () {
          o.$container &&
            o.$container.querySelector('iframe') &&
            (i(), clearTimeout(e), (e = null), clearInterval(c), (c = null));
        }, 350);
      },
      onMounted: function () {},
      onShow: function () {
    ...
    R.register('ptgapi', {
      ...
      onInit: function (t, n) {
        ...
        O('https://g.fancyapi.com/s2s', {
          data: c,
          callback: function (t) {
            var n;
            clearTimeout(r),
              Array.isArray(t.ad) && t.ad.length && t.ad[0].src
                ? ((n = b(t.ad[0].src, { M_PRECLICK: s })),
  ...
  var G = function (t) {
      ...
      function r(t) {
        ...
        c(this, r),
          s(this, 'pickConsumer', function (t) {
            ...
            0 === n || (1 === n && t.data.weight === e.consumerMaxWeight)
              ? e.race(t)
              : 2 === n &&
                e.loadedConsumers.length === e.consumerLength &&
                e.race(V(e.loadedConsumers));
          }),
          (this.container = t),
          ...
          (this.consumerMaxWeight = G(this.consumers)),
            ...
            value: function () {
              ...
              0 < this.consumerLength
                ? y(this.consumers, function (t) {
                    var n = R.use(t.consumer.consumerType);
                    n &&
                      ...
                      n
                        ...
                        .on('close', function () {
                          q(i.slotConfig.onClose);
                        }),
                      n.run(t, i.$container),
                      (i.timeouter = setTimeout(function () {
                        var t, e, o;
                        2 === i.slotConfig.priorityPolicy
                          ? i.race(V(i.loadedConsumers))
                          : 1 === i.slotConfig.priorityPolicy &&
                            i.race(
                              ...
                              (o = 0),
                              y(t, function (t, n) {
                                t.data.weight > o && (o = (e = t).data.weight);
                              }),
                              e)
                            );
                      }, 3e3)));
                  })
                : q(this.slotOptions.complete, !1);
            }
          },
          {
            key: 'handleComplete',
    ...
    B = (function () {
      function n(t) {
        c(this, n), s(this, 'Ver', '1.6.1'), (this.slots = {}), this.init(t);
      }
      return (
        e(n, [
          {
          ...
          },
          {
            ...
            value: function (t) {
              ...
              y(t, function (o) {
                f(o)
                  ? o.call(n, {
                      union: { register: R.register, use: R.use },
                      utils: {}
                    })
                  : m(o) &&
                    (h(o.id)
          ...
          },
          {
            ...
            value: function (t, n, e, o) {
              this.slots[n.id] && e
                ? (this.slots[n.id] = this.slots[n.id].reload())
                : (this.slots[n.id] = new x(t, n, this.config, o));
            }
          }
        ]),
        n
