(function () {
    ...
    CMod.ClickManage = (function () {
      ...
      var cm = {
        ...
        combinedata: function (phrase, obj, pid, oid) {
          ...
          data.g =
            da.clickTime > 0 && da.mousedownTime > 0
              ? da.clickTime - da.mousedownTime
              : da.none;
  ...
  GDTDefine('gdt:comm/proxy.js', function (require, exports, module) {
    ...
    Mshell.prototype = {
      ...
      mock: function () {
        var i = 0,
          len,
          meths = Array.prototype.slice.call(arguments);
  ...
  GDTDefine('gdt:comm/helper.js', function (require, exports, module) {
    ...
    HMod.ENV = (function () {
      ...
      try {
        ...
        if (
          win &&
          win.location.host.indexOf('qzone.qq.com') > 0 &&
          typeof win.g_version == 'number'
        ) {
          m.hosttype = 'qzone';
  ...
  GDTDefine('gdt:comm/config.js', function (require, exports, module) {
    ...
    var burl =
      comm._protocal + Config._curdatadomain + '/' + Config.datapath + '?';
    Config._burl = burl;
    Config._mburl =
      comm._protocal + Config.mdatadomain + '/' + Config.mdatapath + '?';
    Config._mbInnerUrl =
      comm._protocal + Config.innerdomain + '/' + Config.innerdatapath + '?';
    Config._xhrproxyurl =
      comm._protocal + Config._curdatadomain + '/ajaxproxy2.html';
    Config._xhrdataurl =
      comm._protocal + Config._curdatadomain + '/dataproxy.html';
    Config.expconf = {
      PINGWAIT: '11030',
      PCPUSHTPL: 'mapptpl'
    };
  ...
  GDTDefine('gdt:comm/click.js', function (require, exports, module) {
      ...
      if (comm.getType(linklist) == 'array') {
        ...
        comm.each(linklist, function (v, k) {
          if (v && v.nodeType == 1) {
            ...
            comm.each(['mousedown', 'mouseup', 'mouseover'], function (
              mouseevt
            ) {
    ...
    CMod.getOrderLink = function (pid, oid) {
      ...
      var arr = [
        'onclick="return ' + comm.t + '._click( ' + cparam + ' );"',
        'onmousedown="' + comm.t + '. ' + cm + '.mousedown( ' + cparam + ' );"',
        'onmouseup="' + comm.t + '. ' + cm + '.mouseup( ' + cparam + ' );"',
        'onmouseover="' + comm.t + '. ' + cm + '.mouseover( ' + cparam + ' );"',
        'href="' + d._l + '"',
        'gdtoriurl="' + d._l + '"',
        'target = "_blank"'
      ];
  ...
  GDTDefine('gdt:comm/load.js', function (require, exports, module) {
    ...
    NMod.dataUrl = {
      get: function (plist, userdataList) {
        ...
        var url =
          bizconfig._burl +
          comm.getObjectToStringFn('=', '&', false, false)(req);
        return url;
      }
    };
    NMod._get = function () {
  ...
  GDTDefine('gdt:comm/net.js', function (require, exports, module) {
    ...
    NMod.xhrgetter = function (url, callback, ecb, opts) {
      var pid,
        ...
        usecors,
        valuestaturl = 'http://i.gdt.qq.com/view.fcg?xhr2';
      opts = opts || {};
  ...
  GDTDefine('gdt:comm/plugin.js', function (require, exports, module) {
    ...
    PMod._beforeclick = function (data) {
      ...
      obj &&
        click.ClickManage.click(pid, oid, {
          el: obj
        });
    };
    PMod._fixDataURL = function (data_url, plist) {
      require.async('gdt:comm/load.js', function (getter) {
        plist &&
          comm.each(plist, function (pid) {
            var callconf = getter._getCallConf(pid);
            if (
              callconf &&
              callconf.opts &&
              callconf.opts.platform == 'mobile'
            ) {
              if (
                callconf.opts.tempContext &&
                callconf.opts.tempContext.common &&
    ...
    comm.on('gatherparams', function (data) {
      ...
      var ENV = helper.ENV;
      if (
        typeof extreq.hosttype === 'undefined' &&
        typeof ENV.hosttype != 'undefined'
      ) {
        extreq.hosttype = ENV.hosttype;
        extreq.hostver = ENV.hostver + '';
      }
      if (
        typeof extreq.yellow === 'undefined' &&
        typeof ENV.yellow != 'undefined'
      ) {
    ...
    var httpsApptrace = function (url) {
      return url.replace(
        'http://analy.qq.com/cgi-bin/apptrace',
  ...
  function main(cb) {
    ...
    require.setBaseUrl(
      protocal + 'qzonestyle.gtimg.cn/qzone/biz/gdt/display/modules'
    );
