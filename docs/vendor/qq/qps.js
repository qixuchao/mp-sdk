...
if (!GDT._inited) {
  ...
  (function () {
    ...
    GDT._isHttps = (function () {
      ...
      if (
        GDT._isJDPage ||
        (location.hostname.indexOf('qzone.qq.com') >= 0 && ~~window.g_isOFP) ||
        (GDT._isNewsInqq && tail >= 36 && tail <= 36) ||
        GDT._isPageHttps
      ) {
        flag = true;
      }
    ...
    GDT._isApptraceHttps = (function () {
      return (
        (GDT._isHttps && Math.random() * 100 < CONST.HTTPS_APP_TRACE_RATE) ||
        (GDT._isPageHttps &&
          (location.host === 'appcenter.qzone.qq.com' ||
            location.host === 'game.qzone.qq.com'))
      );
    })();
    var _httpsPreload = function () {
      var urls = [
        'https://i.gdt.qq.com/stgw_precon.html',
        'https://v.gdt.qq.com/stgw_precon.html',
        'https://pgdt.gtimg.cn/gdt/0/precon.png/0?_=' + Math.random()
      ];
    ...
    function k(a) {
      ...
      var fk = a.fp;
      a.imgcacheDomain =
        !!fk && fk.imgcacheDomain ? fk.imgcacheDomain : 'imgcache.qq.com';
      ...
      a.lib = {
        ...
        onComplete: function () {
          try {
            ...
            new Image().src =
              'http://c.isdspeed.qq.com/code.cgi?domain=i.gdt.qq.com&cgi=/view.fcg?loaderr&type=1&time=1&rate=1&code=53&r=' +
              Math.random();
          }
        },
        load: function () {
          if (!a.lib._hasLoaded) {
            ...
            var flen,
              _loadedNum = 0,
              _file,
              files = [a.lib._commfile, a.lib._file, a.lib._verfile];
            flen = files.length;
